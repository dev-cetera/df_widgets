...
class Tag extends StatelessWidget {
  ...
  static TagProperties get theme => DI.theme.getSyncOrNull<TagProperties>()?.copyWith() ?? _default;
        ...
        ? TapBox(
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                borderRadius: properties?.borderRadius ?? BorderRadius.circular(4.sc),
              ),
              margin: properties?.margin ?? EdgeInsets.zero,
              padding:
                  properties?.padding ?? EdgeInsets.symmetric(vertical: 4.sc, horizontal: 6.sc),
              child: Text(
                text,
                style: properties?.textStyle ?? Theme.of(context).textTheme.bodySmall?.wMedium,
              ),
            ),
          )
        : const SizedBox();
